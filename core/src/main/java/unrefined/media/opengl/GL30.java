 ...
 * OpenGL ES 3.0
 */
public abstract class GL30 extends GL20 {
    ...
    public abstract void glTexImage3D(
        int target,
        int level,
        int internalformat,
        int width,
    ...
    public abstract void glTexSubImage3D(
        int target,
        int level,
        int xoffset,
        int yoffset,
    ...
    public abstract void glCopyTexSubImage3D(
        int target,
        int level,
        int xoffset,
        int yoffset,
    ...
    public abstract void glCompressedTexImage3D(
        int target,
        int level,
        int internalformat,
        int width,
    ...
    public abstract void glCompressedTexSubImage3D(
        int target,
        int level,
        int xoffset,
        int yoffset,
    ...
    public abstract void glGenQueries(
        int n,
        int[] ids,
        int offset
    );
    ...
    public abstract void glDeleteQueries(
        int n,
        int[] ids,
        int offset
    );
    ...
    public abstract boolean glIsQuery(
        int id
    );

    // C function void glBeginQuery ( GLenum target, GLuint id )

    public abstract void glBeginQuery(
        int target,
        int id
    );
    ...
    public abstract void glGetQueryObjectuiv(
        int id,
        int pname,
        int[] params,
        int offset
    ...
    public abstract boolean glUnmapBuffer(
        int target
    );
     ...
     */
    public abstract java.nio.Buffer glGetBufferPointerv(
        int target,
        int pname
    );
    ...
    public abstract void glDrawBuffers(
        int n,
        int[] bufs,
        int offset
    );
    ...
    public abstract void glUniformMatrix2x3fv(
        int location,
        int count,
        boolean transpose,
        float[] value,
    ...
    public abstract void glUniformMatrix3x2fv(
        int location,
        int count,
        boolean transpose,
        float[] value,
    ...
    public abstract void glUniformMatrix2x4fv(
        int location,
        int count,
        boolean transpose,
        float[] value,
    ...
    public abstract void glUniformMatrix4x2fv(
        int location,
        int count,
        boolean transpose,
        float[] value,
    ...
    public abstract void glUniformMatrix3x4fv(
        int location,
        int count,
        boolean transpose,
        float[] value,
    ...
    public abstract void glUniformMatrix4x3fv(
        int location,
        int count,
        boolean transpose,
        float[] value,
    ...
    public abstract void glBlitFramebuffer(
        int srcX0,
        int srcY0,
        int srcX1,
        int srcY1,
    ...
    public abstract void glRenderbufferStorageMultisample(
        int target,
        int samples,
        int internalformat,
        int width,
    ...
    public abstract void glFramebufferTextureLayer(
        int target,
        int attachment,
        int texture,
        int level,
     ...
     * to be an instance of {@link java.nio.ByteBuffer}.
     */
    public abstract java.nio.Buffer glMapBufferRange(
        int target,
        int offset,
        int length,
        int access
    ...
    public abstract void glFlushMappedBufferRange(
        int target,
        int offset,
        int length
    );
    ...
    public abstract boolean glIsVertexArray(
        int array
    );

    // C function void glGetIntegeri_v ( GLenum target, GLuint index, GLint *data )

    public abstract void glGetIntegeri_v(
        int target,
        int index,
        int[] data,
        int offset
    ...
    public abstract void glBeginTransformFeedback(
        int primitiveMode
    );
    ...
    public abstract void glBindBufferRange(
        int target,
        int index,
        int buffer,
        int offset,
    ...
    public abstract void glTransformFeedbackVaryings(
        int program,
        String[] varyings,
        int bufferMode
    );
    ...
    public abstract void glGetTransformFeedbackVarying(
        int program,
        int index,
        int bufsize,
        int[] length,
    ...
    public abstract String glGetTransformFeedbackVarying(
        int program,
        int index,
        int[] size,
        int sizeOffset,
    ...
    public abstract void glVertexAttribIPointer(
        int index,
        int size,
        int type,
        int stride,
    ...
    public abstract void glGetVertexAttribIiv(
        int index,
        int pname,
        int[] params,
        int offset
    ...
    public abstract void glGetVertexAttribIuiv(
        int index,
        int pname,
        int[] params,
        int offset
    ...
    public abstract void glVertexAttribI4i(
        int index,
        int x,
        int y,
        int z,
    ...
    public abstract void glVertexAttribI4ui(
        int index,
        int x,
        int y,
        int z,
    ...
    public abstract void glVertexAttribI4iv(
        int index,
        int[] v,
        int offset
    );
    ...
    public abstract void glVertexAttribI4uiv(
        int index,
        int[] v,
        int offset
    );
    ...
    public abstract void glGetUniformuiv(
        int program,
        int location,
        int[] params,
        int offset
    ...
    public abstract int glGetFragDataLocation(
        int program,
        String name
    );
    ...
    public abstract void glUniform1ui(
        int location,
        int v0
    );
    ...
    public abstract void glUniform2ui(
        int location,
        int v0,
        int v1
    );
    ...
    public abstract void glUniform3ui(
        int location,
        int v0,
        int v1,
        int v2
    ...
    public abstract void glUniform4ui(
        int location,
        int v0,
        int v1,
        int v2,
    ...
    public abstract void glUniform1uiv(
        int location,
        int count,
        int[] value,
        int offset
    ...
    public abstract void glUniform2uiv(
        int location,
        int count,
        int[] value,
        int offset
    ...
    public abstract void glUniform3uiv(
        int location,
        int count,
        int[] value,
        int offset
    ...
    public abstract void glUniform4uiv(
        int location,
        int count,
        int[] value,
        int offset
    ...
    public abstract void glClearBufferiv(
        int buffer,
        int drawbuffer,
        int[] value,
        int offset
    ...
    public abstract void glClearBufferuiv(
        int buffer,
        int drawbuffer,
        int[] value,
        int offset
    ...
    public abstract void glClearBufferfv(
        int buffer,
        int drawbuffer,
        float[] value,
        int offset
    ...
    public abstract void glClearBufferfi(
        int buffer,
        int drawbuffer,
        float depth,
        int stencil
    ...
    public abstract String glGetStringi(
        int name,
        int index
    );
    ...
    public abstract void glGetActiveUniformBlockName(
        int program,
        int uniformBlockIndex,
        int bufSize,
        int[] length,
    ...
    public abstract String glGetActiveUniformBlockName(
        int program,
        int uniformBlockIndex
    );
    ...
    public abstract void glDrawArraysInstanced(
        int mode,
        int first,
        int count,
        int instanceCount
    ...
    public abstract long glFenceSync(
        int condition,
        int flags
    );
    ...
    public abstract void glWaitSync(
        long sync,
        int flags,
        long timeout
    );
    ...
    public abstract void glGetInteger64v(
        int pname,
        long[] params,
        int offset
    );
    ...
    public abstract void glGetSynciv(
        long sync,
        int pname,
        int bufSize,
        int[] length,
    ...
    public abstract void glGetInteger64i_v(
        int target,
        int index,
        long[] data,
        int offset
    ...
    public abstract void glGetBufferParameteri64v(
        int target,
        int pname,
        long[] params,
        int offset
    ...
    public abstract void glGenSamplers(
        int count,
        int[] samplers,
        int offset
    );
    ...
    public abstract void glDeleteSamplers(
        int count,
        int[] samplers,
        int offset
    );
    ...
    public abstract boolean glIsSampler(
        int sampler
    );

    // C function void glBindSampler ( GLuint unit, GLuint sampler )

    public abstract void glBindSampler(
        int unit,
        int sampler
    );
    ...
    public abstract void glSamplerParameteri(
        int sampler,
        int pname,
        int param
    );
    ...
    public abstract void glSamplerParameteriv(
        int sampler,
        int pname,
        int[] param,
        int offset
    ...
    public abstract void glSamplerParameterf(
        int sampler,
        int pname,
        float param
    );
    ...
    public abstract void glSamplerParameterfv(
        int sampler,
        int pname,
        float[] param,
        int offset
    ...
    public abstract void glGetSamplerParameteriv(
        int sampler,
        int pname,
        int[] params,
        int offset
    ...
    public abstract void glGetSamplerParameterfv(
        int sampler,
        int pname,
        float[] params,
        int offset
    ...
    public abstract void glBindTransformFeedback(
        int target,
        int id
    );
    ...
    public abstract void glDeleteTransformFeedbacks(
        int n,
        int[] ids,
        int offset
    );
    ...
    public abstract void glGenTransformFeedbacks(
        int n,
        int[] ids,
        int offset
    );
    ...
    public abstract boolean glIsTransformFeedback(
        int id
    );
    ...
    public abstract void glGetProgramBinary(
        int program,
        int bufSize,
        int[] length,
        int lengthOffset,
    ...
    public abstract void glProgramBinary(
        int program,
        int binaryFormat,
        java.nio.Buffer binary,
        int length
    ...
    public abstract void glProgramParameteri(
        int program,
        int pname,
        int value
    );
    ...
    public abstract void glInvalidateFramebuffer(
        int target,
        int numAttachments,
        int[] attachments,
        int offset
    ...
    public abstract void glInvalidateSubFramebuffer(
        int target,
        int numAttachments,
        int[] attachments,
        int offset,
    ...
    public abstract void glTexStorage2D(
        int target,
        int levels,
        int internalformat,
        int width,
    ...
    public abstract void glTexStorage3D(
        int target,
        int levels,
        int internalformat,
        int width,
    ...
    public abstract void glGetInternalformativ(
        int target,
        int internalformat,
        int pname,
        int bufSize,
