...
public class WriterOutputStream extends OutputStream {
    ...
    public WriterOutputStream(Writer writer) {
        this(writer, (Charset) null, IOStreams.DEFAULT_BUFFER_SIZE, true);
    }

    public WriterOutputStream(Writer writer, boolean writeImmediately) {
        this(writer, (Charset) null, IOStreams.DEFAULT_BUFFER_SIZE, writeImmediately);
    }

    public WriterOutputStream(Writer writer, int bufferSize) {
        this(writer, (Charset) null, bufferSize, true);
    }

    public WriterOutputStream(Writer writer, int bufferSize, boolean writeImmediately) {
        this(writer, (Charset) null, bufferSize, writeImmediately);
    }

    public WriterOutputStream(Writer writer, Charset charset) {
        this(writer, charset, IOStreams.DEFAULT_BUFFER_SIZE, true);
    }

    public WriterOutputStream(Writer writer, Charset charset, boolean writeImmediately) {
        this(writer, charset, IOStreams.DEFAULT_BUFFER_SIZE, writeImmediately);
    }

    public WriterOutputStream(Writer writer, Charset charset, int bufferSize) {
        this(writer, charset, bufferSize, true);
    }

    public WriterOutputStream(Writer writer, Charset charset, int bufferSize, boolean writeImmediately) {
        this(writer,
            charset == null ? null : charset.newDecoder()
    ...
    public WriterOutputStream(Writer writer, CharsetDecoder decoder) {
        this(writer, decoder, IOStreams.DEFAULT_BUFFER_SIZE, true);
    }

    public WriterOutputStream(Writer writer, CharsetDecoder decoder, boolean writeImmediately) {
        this(writer, decoder, IOStreams.DEFAULT_BUFFER_SIZE, writeImmediately);
    }

    public WriterOutputStream(Writer writer, CharsetDecoder decoder, int bufferSize) {
        this(writer, decoder, bufferSize, true);
    }

    public WriterOutputStream(Writer writer, CharsetDecoder decoder, int bufferSize, boolean writeImmediately) {
        checkIbmJdkWithBrokenUTF16(decoder == null ? Charset.defaultCharset() : decoder.charset());
        this.writer = writer;
        this.decoder = decoder == null ? Charset.defaultCharset().newDecoder() : decoder;
