...
public class AtomicBooleanArray implements java.io.Serializable {
    ...
    /**
     * Creates a new AtomicBooleanArray with the same length as, and
    ...
    public final boolean get(int i) {
        return ATOMIC.getArrayBooleanElementVolatile(array, i);
    }
    ...
    public final void set(int i, boolean newValue) {
        ATOMIC.setArrayBooleanElementVolatile(array, i, newValue);
    }
    ...
    public final void lazySet(int i, boolean newValue) {
        ATOMIC.lazySetArrayBooleanElement(array, i, newValue);
    }
    ...
    public final boolean getAndSet(int i, boolean newValue) {
        return ATOMIC.getAndSetArrayBooleanElement(array, i, newValue);
    }
    ...
    public final boolean compareAndSet(int i, boolean expectedValue, boolean newValue) {
        return ATOMIC.compareAndSetArrayBooleanElement(array, i, expectedValue, newValue);
    }
     ...
     */
    public final boolean weakCompareAndSet(int i, boolean expectedValue, boolean newValue) {
        return ATOMIC.weakCompareAndSetArrayBooleanElement(array, i, expectedValue, newValue);
    }
