...
public final class Rational extends Number implements Comparable<Rational> {
    ...
    /**
     * Constant for the "one" value of the {@code Rational} type.
     *
     * <p>Equivalent to constructing a new rational with any numerator except {@code 0} and
     * the same-number denominator.</p>
     */
    public static final Rational ONE = new Rational(1, 1);

    /**
     * Constant for the "ten" value of the {@code Rational} type.
     */
    ...
    public int hashCode() {
        ...
        int numeratorFlipped = numerator << 16 | numerator >>> 16;

        return denominator ^ numeratorFlipped;
    }
