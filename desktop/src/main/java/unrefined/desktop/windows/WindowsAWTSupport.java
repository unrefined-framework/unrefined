...
public final class WindowsAWTSupport {
    ...
    static {
        if (OSInfo.IS_WINDOWS) {
            long address = WindowsSupport.User32.getSymbolAddress("GetDpiForWindow");
            if (address == 0) {
                GetDpiForWindow = null;
                address = WindowsSupport.User32.getSymbolAddress("MonitorFromWindow");
                if (address == 0) {
                    ...
                    Library Shcore = Library.getCachedInstance(System.mapLibraryName(OSInfo.IS_WINDOWS_CE ? "CoreDLL" : "Shcore"), Library.LAZY | Library.GLOBAL);
                    ...
                    if (address == 0) {
                        ...
                        GetDpiForMonitor = new Function(address,
                                CallContext.getCallContext(Type.UINT32, new Type[] {Type.POINTER, Type.UINT, Type.POINTER, Type.POINTER},
                                        CallingConvention.DEFAULT, false));
