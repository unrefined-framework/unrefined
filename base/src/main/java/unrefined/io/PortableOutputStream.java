...
public class PortableOutputStream extends DataOutputStream implements PortableOutput {

    public PortableOutputStream(OutputStream out) {
        super(out);
    }
    ...
    @Override
    public <T> void writeObject(T obj, BiSlot<T, PortableOutput> writeProc) throws IOException {
        try {
