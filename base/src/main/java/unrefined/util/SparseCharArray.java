...
/**
 * SparseCharArrays map integers to characters.  Unlike a normal array of characters,
 * there can be gaps in the indices.  It is intended to be more memory efficient
 * than using a HashMap to map Integers to Characters, both because it avoids
 ...
 */
public class SparseCharArray implements Cloneable, Iterable<Character>, RandomAccess {
    ...
    public SparseCharArray clone() {
        SparseCharArray clone;
        try {
            clone = (SparseCharArray) super.clone();
        } catch (CloneNotSupportedException e) {
            clone = new SparseCharArray();
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SparseCharArray)) return false;

        SparseCharArray that = (SparseCharArray) o;
