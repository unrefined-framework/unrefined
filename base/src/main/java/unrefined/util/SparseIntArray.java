 ...
 */
public class SparseIntArray implements Cloneable, Iterable<Integer>, RandomAccess {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SparseIntArray)) return false;

        SparseIntArray that = (SparseIntArray) o;
