 ...
 */
public abstract class Bounce extends Equation {

	public static final Bounce IN = new Bounce() {
		@Override
		public float interpolate(float t) {
			return 1 - OUT.interpolate(1-t);
		}
		@Override
	...
	public static final Bounce INOUT = new Bounce() {
		@Override
		public final float interpolate(float t) {
			if (t < 0.5f) return IN.interpolate(t*2) * .5f;
			else return OUT.interpolate(t*2-1) * .5f + 0.5f;
		}
		@Override
		public String toString() {
			return "Bounce.INOUT";
